  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <aside
        ...
        } md:translate-x-0 fixed md:static top-0 left-0 h-full w-64 bg-white dark:bg-gray-800 shadow-lg transition-transform duration-300 ease-in-out z-30 md:min-h-screen`}
      >
